...
- **A (not competitive):** YES
  Chat-eval extra FN vs TF-IDF = 14 (need ≥ 10); A_chat=YES.
  TEST scam-recall gap vs DistilBERT = 0.0020 (need ≥ 0.05); A_test=NO.
- **B (link-heavy extra misses):** NO
  URL-related fraction on chat_eval = 0.000 (need > 0.50). Extra chat-eval FN = 14; URL-related = 0.
