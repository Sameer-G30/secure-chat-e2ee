...
- Scam precision / recall / F1: 0.8768 / 0.9954 / 0.9323
- Legitimate precision / recall / F1: 0.9950 / 0.8673 / 0.9268
- Accuracy: 0.9297
- Combined mean (scam recall, ham precision, accuracy): 0.9733
- Scams missed / ham warned: 16 / 486
- Confusion matrix `[[TN, FP], [FN, TP]]`: `[[3177, 486], [16, 3458]]`

## VALIDATION (threshold/C search; not reported as the final number)

- Scam recall: 0.9931
- Legitimate recall: 0.8710
