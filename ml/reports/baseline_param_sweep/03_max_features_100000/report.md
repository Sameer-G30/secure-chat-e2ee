# 03_max_features_100000

Protocol: one-factor-at-a-time TF-IDF baseline retrain.

**Changed parameter:** `max_features = 100000`
...
- Scam precision / recall / F1: 0.8732 / 0.9954 / 0.9303
- Legitimate precision / recall / F1: 0.9950 / 0.8630 / 0.9243
- Accuracy: 0.9274
- Combined mean (scam recall, ham precision, accuracy): 0.9726
- Scams missed / ham warned: 16 / 502
- Confusion matrix `[[TN, FP], [FN, TP]]`: `[[3161, 502], [16, 3458]]`

## VALIDATION (threshold/C search; not reported as the final number)

- Scam recall: 0.9935
- Legitimate recall: 0.8655
