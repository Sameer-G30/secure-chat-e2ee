...
- Scam precision / recall / F1: 0.8777 / 0.9954 / 0.9328
- Legitimate precision / recall / F1: 0.9950 / 0.8684 / 0.9274
- Accuracy: 0.9302
- Combined mean (scam recall, ham precision, accuracy): 0.9735
- Scams missed / ham warned: 16 / 482
- Confusion matrix `[[TN, FP], [FN, TP]]`: `[[3181, 482], [16, 3458]]`

## VALIDATION (threshold/C search; not reported as the final number)

- Scam recall: 0.9931
- Legitimate recall: 0.8706
