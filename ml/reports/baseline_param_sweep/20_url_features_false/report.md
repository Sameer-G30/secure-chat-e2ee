...
- Scam precision / recall / F1: 0.8741 / 0.9954 / 0.9308
- Legitimate precision / recall / F1: 0.9950 / 0.8640 / 0.9249
- Accuracy: 0.9280
- Combined mean (scam recall, ham precision, accuracy): 0.9728
- Scams missed / ham warned: 16 / 498
- Confusion matrix `[[TN, FP], [FN, TP]]`: `[[3165, 498], [16, 3458]]`

## VALIDATION (threshold/C search; not reported as the final number)

- Scam recall: 0.9932
- Legitimate recall: 0.8692
