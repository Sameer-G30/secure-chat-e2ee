...
export default function SettingsTheme({ goBackToGeneral, closeSettings, selectedTheme, applyTheme }) {
    return (
        <>
            ...
            <div className="settings-content">
                <div className={`theme-option ${selectedTheme === 'light' ? 'active' : ''}`} onClick={() => applyTheme('light')}>
                ...
                <div className={`theme-option ${selectedTheme === 'dark' ? 'active' : ''}`} onClick={() => applyTheme('dark')}>
                    <div className="theme-option-content">
                ...
                <div className={`theme-option ${selectedTheme === 'system' ? 'active' : ''}`} onClick={() => applyTheme('system')}>
                    <div className="theme-option-content">
